...
void PFApplication::createSyncObjects()
{
...
void PFApplication::createDescriptorSets()
{
...
void PFApplication::createDescriptorPool()
{
...
void PFApplication::createDescriptorSetLayout()
{
...
void PFApplication::createCommandBuffer()
{
...
void PFApplication::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
{
...
void PFApplication::createCommandPool()
{
...
void PFApplication::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size)
{
    VkCommandBufferAllocateInfo allocInfo{};
    allocInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
    allocInfo.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
...
void PFApplication::createBuffer(
    VkDeviceSize size,
...
void PFApplication::createUniformBuffers()
{
...
void PFApplication::createIndexBuffer()
{
...
void PFApplication::createVertexBuffer()
{
...
void PFApplication::updateUniformBuffer(uint32_t currentImage)
{
    ...
    UniformBufferObject ubo = getUpdatedUniforms(swapchainExtent.width / (float)swapchainExtent.height);
...
uint32_t PFApplication::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties)
{
